...
export let Model = Mixin.create({
  ...
  фИО: DS.attr('string'),
  транспСр: DS.belongsTo('i-i-s-o-l-трансп-ср', { inverse: null, async: false })
});
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ЖурналУчетаE', 'i-i-s-o-l-журнал-учета', {
    ...
    транспСр: belongsTo('i-i-s-o-l-трансп-ср', 'Трансп ср', {
  ...
  modelClass.defineProjection('ЖурналУчетаL', 'i-i-s-o-l-журнал-учета', {
    ...
    примечания: attr('Примечания', { index: 5 }),
    дата: attr('Дата', { index: 6 }),
    транспСр: belongsTo('i-i-s-o-l-трансп-ср', 'Марка', {
