...
namespace IIS.OL
{
    ...
    public class ЖурналУчета : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OL.ТранспСр fТранспСр;
        ...
        [PropertyStorage(new string[] {
                "ТранспСр"})]
        [NotNull()]
        public virtual IIS.OL.ТранспСр ТранспСр
        {
            get
            {
                ...
                IIS.OL.ТранспСр result = this.fТранспСр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЖурналУчетаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЖурналУчетаE", typeof(IIS.OL.ЖурналУчета));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЖурналУчетаL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЖурналУчетаL", typeof(IIS.OL.ЖурналУчета));
                }
            }
        }
    }
