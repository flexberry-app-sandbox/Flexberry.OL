...
namespace IIS.OL
{
    ...
    public class Контрагент : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OL.ТЧЗаданВод fТЧЗаданВод;
        ...
        [PropertyStorage(new string[] {
                "ТЧЗаданВод"})]
        [NotNull()]
        public virtual IIS.OL.ТЧЗаданВод ТЧЗаданВод
        {
            get
            {
                ...
                IIS.OL.ТЧЗаданВод result = this.fТЧЗаданВод;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтрагентE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентE", typeof(IIS.OL.Контрагент));
                }
            }
            ...
            public static ICSSoft.STORMNET.View КонтрагентL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтрагентL", typeof(IIS.OL.Контрагент));
                }
            }
        }
    }
