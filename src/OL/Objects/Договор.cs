...
namespace IIS.OL
{
    ...
    [View("ДоговорE", new string[] {
            ...
            "Организация.Почта as \'Почта\'"}, Hidden=new string[] {
            "РукОтдЛог.ФИО",
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.OL.РукОтдЛог fРукОтдЛог;
        
        private IIS.OL.Контрагент fКонтрагент;
        
        private IIS.OL.Организация fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "Контрагент"})]
        [NotNull()]
        public virtual IIS.OL.Контрагент Контрагент
        {
            get
            {
                ...
                IIS.OL.Контрагент result = this.fКонтрагент;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.OL.Организация Организация
        {
            get
            {
                ...
                IIS.OL.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "РукОтдЛог"})]
        [NotNull()]
        public virtual IIS.OL.РукОтдЛог РукОтдЛог
        {
            get
            {
                ...
                IIS.OL.РукОтдЛог result = this.fРукОтдЛог;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.OL.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.OL.Договор));
                }
            }
        }
    }
