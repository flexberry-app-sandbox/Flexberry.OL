...
namespace IIS.OL
{
    ...
    [View("РукОтдЛогE", new string[] {
            ...
            "Персонал.Контакты"})]
    [MasterViewDefineAttribute("РукОтдЛогE", "Персонал", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Контакты")]
    ...
    public class РукОтдЛог : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РукОтдЛогE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РукОтдЛогE", typeof(IIS.OL.РукОтдЛог));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РукОтдЛогL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РукОтдЛогL", typeof(IIS.OL.РукОтдЛог));
                }
            }
        }
    }
